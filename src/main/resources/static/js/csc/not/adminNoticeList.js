...
function adminNoticeList() {
	...
	function renderPagination({ startPage, endPage, currentPage, totalPages }) {
		...
		const footer = document.querySelector('.noticeListPaging'); // 클래스 선택자를 .noticeListPaging로 변경
	...
	// 새로운 전용 페이지네이션 이벤트 리스너 추가
	const noticePaginationContainer = document.querySelector('.noticeListPaging');
	if (noticePaginationContainer) {
		noticePaginationContainer.addEventListener('click', e => {
