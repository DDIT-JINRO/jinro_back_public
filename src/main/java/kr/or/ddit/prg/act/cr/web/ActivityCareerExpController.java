...
public class ActivityCareerExpController {
	...
	public String selectCrList(Model model, @RequestParam(defaultValue = "1") int currentPage,
	...
	public String selectCrDetail(@RequestParam String crId, Model model) {
		ActivityVO crDetail = activityCareerExpService.selectCrDetail(crId);
		model.addAttribute("crDetail", crDetail);
