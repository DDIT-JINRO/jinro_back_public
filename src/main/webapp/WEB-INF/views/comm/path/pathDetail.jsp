...
<div>
	<div class="public-wrapper">
		...
		<div class="public-wrapper-main">
					...
					<c:when test="${not empty fileList}">
						<c:forEach var="file" items="${fileList}">
							<div class="detailFile">
								<div class="file-info">
									<a href="/files/download?fileGroupId=${file.fileGroupId}&seq=${file.fileSeq}" class="file-name" title="파일명을 클릭하여 다운로드"> ${file.fileOrgName} </a>
								</div>
			...
			<form action="/comm/path/createPathReply.do" method="post" class="comment-form">
			...
			<div class="comment-section">
				...
				<div class="bottom-button">
					<a href="/comm/peer/youth/youthList.do" class="btn-back">목록</a>
				</div>
			</div>
		</div>
	</div>
...
<script src="/js/comm/path/pathDetail.js"></script>
</html>