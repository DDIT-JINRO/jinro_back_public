...
<div>
	<div class="public-wrapper">
		...
		<div class="public-wrapper-main">
			<form method="get" action="/comm/path/pathList.do" class="search-filter__form">
				<div class="search-filter__bar">
					...
					<div class="search-filter__input-wrapper">
						<input type="search" class="search-filter__input" name="keyword" placeholder="진로/진학 게시판 내에서 검색" value="${param.keyword}">
			...
			<p class="content-list__total-count">해당 게시판은 진로/진학을 고민하고 논의하는 게시판입니다.</p>
...
<script src="/js/comm/path/pathList.js">
	// 스크립트 작성 해주시면 됩니다.
</script>
</html>