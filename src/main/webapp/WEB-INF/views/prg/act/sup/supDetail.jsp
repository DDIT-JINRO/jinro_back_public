		...
		<div class="public-wrapper-main">
			...
			<div class="detail-title-wrapper">
				...
				<div class="meta-info">
					...
					<span>
						게시일:
						<fmt:formatDate value="${supDetail.contestCreatedAt}" pattern="yyyy. M. d." />
					</span>
					<span class="divider">|</span>
				...
				<div class="summary-wrapper">
					...
					<table class="info-table">
						<tbody>
							<tr>
								<th>주최</th>
								<td>${supDetail.contestHost}</td>
							</tr>
							<tr>
								<th>주관</th>
								<td>${supDetail.contestOrganizer}</td>
							</tr>
							<tr>
								<th>접수기간</th>
								<td><fmt:formatDate value="${supDetail.contestStartDate}" pattern="yyyy. M. d." /> ~ <fmt:formatDate value="${supDetail.contestEndDate}" pattern="yyyy. M. d." /></td>
							</tr>
							<tr>
								<th>참가자격</th>
								<td>${supDetail.contestTargetName}</td>
							</tr>
							<tr>
								<th>접수방법</th>
								<td>${supDetail.applicationMethod}</td>
							</tr>
							<tr>
								<th>시상종류</th>
								<td>${supDetail.awardType}</td>
							</tr>
							<tr>
								<th>홈페이지</th>
								<td><a href="${supDetail.contestUrl}" target="_blank">바로가기</a></td>
							</tr>
						</tbody>
					</table>
				</div>
