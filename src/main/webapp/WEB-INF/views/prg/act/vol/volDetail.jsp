				...
				<div class="summary-wrapper">
					...
					<table class="info-table">
						<tbody>
							<tr>
								<th>주최</th>
								<td>${volDetail.contestHost}</td>
							</tr>
							<tr>
								<th>주관</th>
								<td>${volDetail.contestOrganizer}</td>
							</tr>
							<tr>
								<th>접수기간</th>
							...
							<tr>
								<th>참가자격</th>
								<td>${volDetail.contestTargetName}</td>
							</tr>
							<tr>
								<th>접수방법</th>
								<td>${volDetail.applicationMethod}</td>
							</tr>
							<tr>
								<th>시상종류</th>
								<td>${volDetail.awardType}</td>
							</tr>
							<tr>
								<th>홈페이지</th>
								<td><a href="${volDetail.contestUrl}" target="_blank">바로가기</a></td>
							</tr>
						</tbody>
					</table>
				</div>
