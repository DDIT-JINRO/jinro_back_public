		...
		<div class="public-wrapper-main">
			<div class="detail-title-wrapper">
				...
				<div class="meta-info">
					...
					<span>
						게시일:
						<fmt:formatDate value="${cttDetail.contestCreatedAt}" pattern="yyyy. M. d." />
					</span>
					<span class="divider">|</span>
				...
				<div class="summary-wrapper">
					...
					<table class="info-table">
						<tbody>
							<tr>
								<th>주최</th>
								<td>${cttDetail.contestHost}</td>
							</tr>
							<tr>
								<th>주관</th>
								<td>${cttDetail.contestOrganizer}</td>
							</tr>
							<tr>
								<th>응모분야</th>
								<td>${cttDetail.contestTypeName}</td>
							</tr>
							<tr>
								<th>접수기간</th>
								<td><fmt:formatDate value="${cttDetail.contestStartDate}" pattern="yyyy. M. d." /> ~ <fmt:formatDate value="${cttDetail.contestEndDate}" pattern="yyyy. M. d." /></td>
							</tr>
							<tr>
								<th>참가자격</th>
								<td>${cttDetail.contestTargetName}</td>
							</tr>
							<tr>
								<th>접수방법</th>
								<td>${cttDetail.applicationMethod}</td>
							</tr>
							<tr>
								<th>시상종류</th>
								<td>${cttDetail.awardType}</td>
							</tr>
							<tr>
								<th>홈페이지</th>
								<td><a href="${cttDetail.contestUrl}" target="_blank">바로가기</a></td>
							</tr>
						</tbody>
					</table>
				</div>
