...
<div class="public-wrapper">
	...
	<div class="public-wrapper-main">
		<div class="filter-section">
			<form method="get" action="/prg/ctt/cttList.do" class="search-filter__form">
					...
					<div class="search-filter__accordion-panel" id="search-filter-panel">
						<div class="search-filter__accordion-content">
							<div class="search-filter__group">
								<label class="search-filter__group-title">모집 분야</label>
								<div class="search-filter__options">
									<c:forEach var="cType" items="${contestTypeList}">
										<label class="search-filter__option">
											<input type="checkbox" name="contestTypeFilter" value="${cType.ccId}" <c:if test="${fn:contains(checkedFilters.contestTypeFilter, cType.ccId)}">checked</c:if> />
		...
		<div class="source-div">
			<span class="list-header__meta-item list-header__meta-item--source">[ 출처: 씽굿(Thinkcontest.com), 대학문화신문사 ]</span>
			...
			<ul class="pagination">
				<li>
					<c:url value="/prg/ctt/cttList.do" var="prevUrl">
						...
						<c:forEach var="filter" items="${checkedFilters.contestTypeFilter}">
							<c:param name="contestTypeFilter" value="${filter}" />
						</c:forEach>
