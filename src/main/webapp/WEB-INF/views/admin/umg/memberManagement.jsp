			...
			<div class="template-panel" style="width: 796px;">
				<div class="flex space-between">
					...
					<div class="btn-group flex gap5 userOnlineChart">
						<input type="hidden" id="userOnlineChartStartDay" /> <input type="hidden"
							id="userOnlineChartEndDay" /> <select class="public-toggle-select" name="userOnlineChartDay"
						...
						</select> <select class="public-toggle-select" name="userOnlineChartAgeGroup"
							id="userOnlineChartAgeGroup">
			...
			<div class="template-panel" style="width: 796px;">
				<div class="flex space-between">
					...
					<div class="btn-group flex gap5 pageVisitChart">
						<input type="hidden" id="pageVisitChartStartDay" /> <input type="hidden"
							id="pageVisitChartEndDay" /> <select class="public-toggle-select" name="pageVisitChartDay"
	...
	<div id="memberMngSpace" style="display: none;">
			...
			<div class="template-panel" style="width: 796px;">
				...
				<div class="search-filter-bar userListPtagList">
					<p class="ptag-list">
						...
						건
						<span class="pageCnt"> (Page <span id=memListPage></span>/<span id=memListTotalPage></span>)</span>
			</p>
				</div>
					...
					<div class="profileInfo-1">
						<div class="profileInfo-1-1">
							<div class="profile-container">
								...
								<div class="profile-info">
									<label for="mem-nickname"> </label> <input type="text" id="mem-id"
										style="display: none"> <input id="mem-nickname" class="profile-nickname">
						...
						<div class="profileInfo-1-2">
							<div class="info-field">
								<label for="mem-name">이름</label> <input id="mem-name" type="text" value=""
									disabled="disabled">
							</div>
							<div class="info-field">
								<label for="mem-phone">휴대전화</label> <input id="mem-phone" type="text" value="" disabled>
							</div>
							<div class="info-field">
								<label>생년월일</label> <input type="text" value="" id="mem-birth" disabled>
							</div>
							<div class="info-field">
								<label>로그인 타입</label> <input id="mem-logType" type="text" value="" disabled="disabled">
							</div>
						</div>
						<div class="profileInfo-1-3">
							<div class="info-field">
								<label>이메일</label> <input id="mem-email" type="email" value="" disabled>
							</div>
							<div class="info-field">
								<label>성별</label> <input id="mem-gen" type="text" value="" disabled>
							</div>
							<div class="info-field">
								<label>경고수</label> <input id="mem-warn-count" type="text" value="" disabled>
							</div>
							<div class="info-field">
								<label>정지수</label> <input id="mem-ban-count" type="text" value="" disabled>
							</div>
						</div>
			...
			<div class="template-panel usagePersonChart">
				<div class="flex space-between">
					...
					<div class="btn-group flex gap5">
						<input type="hidden" id="personChartStartDay" /> <input type="hidden" id="personChartEndDay" />
		...
		<div class="search-filter-bar">
			<p class="ptag-list pageLogCount">
				총<span id="pageLog-count"></span>건
				<span class="pageCnt" style="margin-top: 20px;"> (Page <span id=memPageVisitPage></span>/<span id=memPageVisitTotalPage></span>)</span>
			</p>
		</div>
		<div
