...
<div class="public-wrapper">
	...
	<div class="public-wrapper-main">
		<form method="get" action="/cdp/imtintrvw/intrvwqestnmn/interviewQuestionMangementList.do" class="search-filter__form">
			<div class="search-filter__bar">
				<div class="search-filter__input-wrapper">
					<input type="search" name="keyword" value="${param.keyword}" class="search-filter__input" placeholder="면접 질문 제목 검색">
					...
					<c:forEach var="question" items="${articlePage.content}">
						<div class="list-card">
							<div class="list-card__info">
								<h3 class="list-card__title">${question.idlTitle}</h3>
								<div class="list-card__meta">
									<div class="list-card__meta-item">
										<span class="list-card__meta-label">수정일:</span>
										<fmt:formatDate value="${question.idlUpdatedAt}" pattern="yyyy. M. d. (E) HH:mm" />
									</div>
									<div class="list-card__meta-item">
										<span class="list-card__meta-label">상태:</span>
										<span class="list-card__status <c:choose><c:when test='${question.idlStatus eq \"완료\"}'>list-card__status--completed</c:when><c:otherwise>list-card__status--draft</c:otherwise></c:choose>">
											<c:choose>
							...
							<div class="list-card__actions">
								<a class="list-card__edit-button" href="/cdp/imtintrvw/intrvwqestnmn/detail.do?idlId=${question.idlId}"> 면접 질문 수정하기 </a>
							</div>
						</div>
					</c:forEach>
				</c:when>
		...
		<sec:authorize access="isAuthenticated()">
			<div class="list__footer">
				<a href="/cdp/imtintrvw/intrvwqestnlst/intrvwQuestionList.do" class="list__create-button"> 면접 질문 작성하기 </a>
			</div>
		</sec:authorize>
...
<script type="text/javascript" src="/js/cdp/imtintrvw/intrvwqestnmn/interviewQuestionMangement.js"></script>
